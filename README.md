...
- **Cloud Services**: AWS S3, AWS EC2, AWS IAM
    <div align="center">
      <img src="https://github.com/user-attachments/assets/c9985f2d-8dfd-43b7-ac8c-d31744485b7a" alt="프로젝트 구조" width="70%">
    </div>
...
- **성과**:
    - 쌀키우기 테스트 프로젝트와 가나다 퍼즐 게임 프로젝트의 성과로 **잇다 서포터즈 6기 활동**에서 **‘우수 서포터즈 표창’**을 수상
